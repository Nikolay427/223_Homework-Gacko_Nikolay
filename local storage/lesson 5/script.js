...
let dateDay = notebook.querySelector('#date');
let month = notebook.querySelector('#month');
let year = notebook.querySelector('#year');
let event = notebook.querySelector('#event');
let date = new Date();
